...
save(summary_mods_high_60,
     file = paste0("~/tb-seamless/data/bayes-generated/", Sys.Date(), "_simulated-lmm_random-slope_lod-25_nk-60_high-condition_modresults-", max(sims), ".RData"))
...
save(mcmc_mods_high_60,
     file = paste0("~/tb-seamless/data/bayes-generated/", Sys.Date(), "_simulated-lmm_random-slope_lod-25_nk-60_high-condition_mcmc-", max(sims), ".RData"))
...
save(summary_mods_high_80,
     file = paste0("~/tb-seamless/data/bayes-generated/", Sys.Date(), "_simulated-lmm_random-slope_lod-25_nk-80_high-condition_modresults-", max(sims), ".RData"))
...
save(mcmc_mods_high_80,
     file = paste0("~/tb-seamless/data/bayes-generated/", Sys.Date(), "_simulated-lmm_random-slope_lod-25_nk-80_high-condition_mcmc-", max(sims), ".RData"))
