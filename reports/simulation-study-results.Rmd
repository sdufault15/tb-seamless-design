...
p1 <- s95.sit1.all %>% # pull out sub-optimal regimen
...
p2 <- s90.sit1.all %>% 
  ...
  scale_y_continuous("P(stopped for futility)",
                     ...
                     labels = seq(0,1,by = 0.1)) + 
  ggtitle("Interim 1 Analysis of Futility - Relapse", 
          subtitle = "Sub-optimal regimen (relapse rate = 20%). Control relapse rate is 10%.")
...
p3 <-  s97.sit1.all %>% 
  ...
  scale_y_continuous("P(stopped for futility)",
                     ...
                     labels = seq(0,1,by = 0.1)) + 
  ggtitle("Interim 1 Analysis of Futility - Relapse", 
          subtitle = "Sub-optimal regimen (relapse rate = 6%). Control relapse rate is 3%.")
